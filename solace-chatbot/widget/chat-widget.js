...
function Concierge(opts) {
  ...
  this.load(_concierge_chat_host + "/chat-widget.css", function() {
    ...
    this.container = $("<div id = 'widget'>", { class: "_concierge_chat_container _concierge_min"});
    $("#widgetsec").append(this.container);
	$("#widgetsec").css({'display':'block'});
	//document.getElementById("widgetsec").innerHTML='<object type="type/html" data="home.html" ></object>';

	//document.getElementById("widgetsec").append(this.container);
	//ar x = document.getElementById("widget").innerHTML;
	//document.getElementById("widgetsec").innerHTML=x;
    ...
    this.connect = function() {
      ...
      this.renderChatWindow = function() {
        ...
        var chat_button = $("<button>", { class: "_concierge_chat_btn", name: "_concierge_chat_btn", id: "_concierge_chat_btn", type: "button" }).text("Send")
